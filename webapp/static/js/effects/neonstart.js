 ...
 *
 * Слой во весь экран, который рывками обесцвечивает то, что под ним:
 * раз — разраз — и горит. Мигает от этого фиолетовое, а не страница.
 * Сама анимация в `css/effects/neon-start.css`, здесь только слой и его
 * уборка.
 *
