 ...
 *
 * Движения нарочно медленные и мелкие. Фон, который заметно шевелится,
 * отвлекает от текста, ради которого программа и написана: заметить его
 * можно, только если специально присмотреться.
 */
...
const STARS_DEPTHS = [
  {share: 0.60, dim: 0.10, bright: 0.25, size: 1.0, glow: false},
  {share: 0.30, dim: 0.30, bright: 0.50, size: 1.5, glow: false},
  {share: 0.10, dim: 0.55, bright: 0.85, size: 2.0, glow: true},
];

//: Мерцание: длительность полного цикла у каждой точки своя.
