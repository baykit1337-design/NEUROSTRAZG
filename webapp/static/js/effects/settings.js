...
const EFFECTS = [
  ...
  },
  {
    key: 'aurora',
    name: 'Аврора на фоне',
    hint: 'Размытые фиолетовые пятна, медленно перетекающие по фону.',
    on: true,
  },
  {
    key: 'grain',
    name: 'Плёночное зерно',
    hint: 'Едва заметный шум поверх фона — убирает плоскость тёмной темы.',
    on: true,
  },
  {
    key: 'spotlight',
    name: 'Прожектор за курсором',
    hint: 'Мягкое свечение следует за указателем.',
    on: true,
  },
  {
    key: 'cursor',
    name: 'Свой курсор',
    hint: 'Стрелка под тему: тёмная заливка, неоновый контур. В полях '
      + 'ввода и на выключенных кнопках курсор остаётся системным.',
    on: false,
  },
  {
    key: 'magnetic',
