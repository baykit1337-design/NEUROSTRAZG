...
const EFFECTS = [
  ...
  },
  {
    ...
    hint: 'При запуске страница разгорается, как неоновая вывеска: раз — '
      + 'разраз — раз — разразраз — включилось. Один раз за запуск; '
      + 'переключение вкладок вывеску заново не зажигает.',
    on: true,
  },
];
