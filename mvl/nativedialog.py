...
def ask_any(title: str = "Выберите файлы или папку", initial: str = "") -> list[str]:
    """Сначала файлы, иначе папка. Интерфейсом больше не используется.
    ...
    Отсюда и беда, из-за которой кнопка «Выбрать…» на эту дорогу больше не
    сворачивает: отказ и пустой выбор Tk отдаёт одинаково, отличить их
    нечем, — и «Отмена» в первом окне открывала второе. Теперь файлы или
    папку спрашивают до окна, и окно остаётся одно.
    """
