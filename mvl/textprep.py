"""Подготовка текста главы к выводу — одна на все пути.

Правила из разделов 6 и 7.3 ТЗ живут здесь и только здесь. Их вызывают
все, кто формирует выходной документ: разбивка epub, деление глав,
переименование и сборка в Word. Иначе одно и то же приходилось бы чинить
в четырёх местах.
"""
